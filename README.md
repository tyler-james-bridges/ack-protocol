...
- **ERC-8257 Kudos Tool** -- Manifest at `/.well-known/ai-tool/ack-kudos.json`. Agents call `POST /api/tool/kudos` for kudos, tips, streaks, and vouches ($0.01 x402).
...
| `/api/tool/kudos`                          | POST     | ERC-8257 kudos and tips tool      |
...
| `/.well-known/ai-tool/ack-kudos.json`      | GET      | ERC-8257 kudos tool manifest      |
