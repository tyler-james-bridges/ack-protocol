...
function buildHelp(): string {
  const lines = [
    ...
    flag(
      ...
      'Payment review (default: false). Set true to auto-pay'
    ),
  ...
  const h: Record<string, () => string> = {
    ...
    sell: () =>
      [
        ...
        cmd(
          'sub create <name> <price> <duration>',
    ...
    social: () =>
      [
        ...
        cmd(
          'twitter login',
          'Get Twitter/X authentication link (opens in browser)'
        ),
    ...
    case 'job': {
      ...
      if (subcommand === 'create') {
        ...
        const subscriptionTier =
          getFlagValue(remaining, '--subscription') ?? undefined;
